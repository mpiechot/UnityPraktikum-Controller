...
using System.IO;
using System;
public class StateTransitionTE : MonoBehaviour,IState
{
    ...
    public void Enter()
    {
        ...
        text.text = "Die Übungsphase ist nun beendet. Drücke Leertaste, wenn du bereit bist das Experiment zu beginnen";
