...
public class StateWelcome : MonoBehaviour, IState {
    ...
    public void Enter() {
        ...
        string clientHeader = "Fingerstimulation;LightEffectSide;StimulationStart;ObjectColor;SuccessfulFinished;ErrorCode;ReactionTime;SpokenWord;HandPositions" + Environment.NewLine;
